...
def test_mail_is_spam_or_not(mailBody):
    ...
    # Ensure train_sizes are within the valid range
    sample_space = [100, 200, 500, 1000, 1500, 2000]  # example valid values
    ...
    g = sns.FacetGrid(make_tidy(sample_space, train_scores, valid_scores), hue='Scores')
